    ...
    <div className="p-4 sm:p-6 lg:p-8 bg-gray-100 min-h-screen">
      ...
      <div className="mb-6 lg:mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gray-900 rounded-xl text-sm font-medium text-white hover:bg-gray-800 transition-colors shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          ...
          <div className="text-2xl font-bold text-gray-900">{formatMoney(stats.mrr)} ₸</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-5 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900">Лента активности</h3>
          </div>
