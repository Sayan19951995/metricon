    ...
    <>
      ...
      <div className="p-4 lg:p-6">
        <div className="flex items-center gap-3 mb-6 lg:mb-8">
          <div className="w-10 h-10 bg-green-500/20 backdrop-blur rounded-xl flex items-center justify-center">
          ...
          <div className="text-white">
            ...
            <div className="text-xs text-green-400 font-medium">ADMIN</div>
          </div>
        </div>
      </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-gradient-to-r from-gray-900 to-gray-800 flex items-center justify-between px-4 z-50 shadow-lg">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-green-500/20 backdrop-blur rounded-lg flex items-center justify-center">
