    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Загрузка цен конкурентов...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Мониторинг цен конкурентов</h1>
              <p className="text-gray-600">Отслеживайте цены конкурентов на Kaspi.kz</p>
            </div>
            <button
              onClick={() => router.push('/dashboard')}
              className="px-6 py-3 backdrop-blur-lg bg-white/60 text-gray-900 rounded-xl hover:bg-white/80 transition-all shadow-lg border border-white/20"
            >
              ← Назад
            </button>
          </div>
          ...
          {/* URL Input */}
          <div className="backdrop-blur-lg bg-white/60 rounded-2xl shadow-xl border border-white/20 p-6">
              ...
              <div className="flex-1">
                ...
                {error && (
                  <div className="mt-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-sm text-red-900 font-semibold mb-2">Ошибка</p>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              ...
              <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-900 font-semibold mb-1">⚠️ Если не получается автоматически:</p>
                <p className="text-xs text-yellow-800">
                  Kaspi может блокировать автоматические запросы. В этом случае:
                </p>
                <ol className="text-xs text-yellow-800 list-decimal list-inside mt-1 space-y-0.5">
        ...
        {result && (
          ...
          >
            {/* Product Info */}
            <div className="backdrop-blur-lg bg-white/60 rounded-2xl shadow-xl border border-white/20 p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">{result.productName}</h2>
              <a
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
                  <p className="text-sm text-green-700 mb-1">Минимальная цена</p>
                ...
                {result.yourPrice && (
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
                    <p className="text-sm text-blue-700 mb-1">Ваша цена</p>
                ...
                {result.yourPosition && (
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
                    <p className="text-sm text-purple-700 mb-1">Ваша позиция</p>
                ...
                {!result.yourPrice && (
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                    <p className="text-sm text-gray-700 mb-1">Всего продавцов</p>
              ...
              >
                {result.prices.map((competitor, index) => (
                  <motion.div
                    ...
                    className={`p-6 hover:bg-white/80 transition-all ${
                      competitor.isCurrentMerchant ? 'bg-blue-50/50' : ''
                    }`}
                  >
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-1">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-sm text-gray-600">{competitor.rating.toFixed(1)}</span>
                            </div>
            ...
            {result.yourPrice && result.lowestPrice < result.yourPrice && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="backdrop-blur-lg bg-orange-50/60 border border-orange-200/20 rounded-2xl p-6"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-orange-900 mb-2">Рекомендация по цене</h3>
                    ...
                    <div className="bg-white rounded-lg p-4 inline-block">
                      <p className="text-sm text-gray-600">Рекомендуемая цена</p>
            ...
            {result.yourPrice && result.yourPrice === result.lowestPrice && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="backdrop-blur-lg bg-green-50/60 border border-green-200/20 rounded-2xl p-6"
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-green-900 mb-2">🏆 Отличная работа!</h3>
