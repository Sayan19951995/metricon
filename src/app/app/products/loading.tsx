      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {[...Array(12)].map((_, i) => (
          <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm">
            <div className="aspect-square bg-gray-200 dark:bg-gray-700 rounded-lg animate-pulse mb-3" />
            <div className="h-4 w-full bg-gray-200 dark:bg-gray-600 rounded animate-pulse mb-2" />
            <div className="h-3 w-2/3 bg-gray-100 dark:bg-gray-700 rounded animate-pulse mb-3" />
