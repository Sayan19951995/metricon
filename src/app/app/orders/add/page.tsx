  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Добавить заказ вручную</h1>
      ...
      <div>
        <form onSubmit={handleSubmit} className="max-w-3xl">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm mb-6">
            ...
            <button
              type="button"
              className="w-full border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl px-4 py-12 text-gray-500 dark:text-gray-400 hover:border-emerald-500 hover:text-emerald-600 hover:bg-emerald-50/30 dark:hover:bg-emerald-900/20 transition-all group cursor-pointer"
            >
              <div className="flex flex-col items-center gap-3">
                <div className="w-12 h-12 bg-gray-100 dark:bg-gray-700 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 rounded-xl flex items-center justify-center transition-colors">
