    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 mt-1">Управление email, push и Telegram уведомлениями</p>
        </motion.div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                  soundEnabled ? 'bg-emerald-100' : 'bg-gray-100'
                }`}>
                  {soundEnabled ? (
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Звуковые уведомления</h3>
                  <p className="text-sm text-gray-500">Воспроизводить звук при новых уведомлениях</p>
                </div>
              </div>
              <button
          ...
          <motion.div variants={itemVariants} className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">robo@example.com</p>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <h4 className="font-medium text-gray-900 mb-4">Отчёты</h4>
              <div className="divide-y divide-gray-100">
                <NotificationToggle
                  icon={Mail}
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                  telegramConnected ? 'bg-[#0088cc]/10' : 'bg-gray-100'
                }`}>
              ...
              {telegramConnected ? (
                <button
                  ...
                  className="px-4 py-2 bg-red-100 text-red-600 rounded-xl text-sm font-medium hover:bg-red-200 transition-colors cursor-pointer"
                >
                  Отключить
                </button>
              ) : (
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-center text-lg tracking-widest focus:outline-none focus:border-[#0088cc] transition-colors"
                      placeholder="XXXXXX"
                      maxLength={6}
                    />
                  </div>
